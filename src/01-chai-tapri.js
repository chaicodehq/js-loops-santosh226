...
export function chaiTapriRevenue(customers) {
  ...
  //way 1
  // const totalAdrakChai = Math.round(customers / 3);
  // const totalRegularChai = Math.round(customers - totalAdrakChai);

  // totalRevenue = (totalAdrakChai * 15) + (totalRegularChai * 10);
